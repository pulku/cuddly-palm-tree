...
import com.example.ppmtool.payload.JwtLLoginSuccessResponse;
...
public class UserController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest loginRequest, BindingResult result) {
        ...
        return ResponseEntity.ok(new JwtLLoginSuccessResponse(true, jwt));
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody User user, BindingResult result) {
        ...
        return errorMap == null ? new ResponseEntity<>(userService.saveUser(user), HttpStatus.CREATED) : errorMap;
